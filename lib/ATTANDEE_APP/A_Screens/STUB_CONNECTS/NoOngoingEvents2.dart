...
class NoOngoingEvent2 extends StatefulWidget {
  const NoOngoingEvent2({super.key});

  @override
  State<NoOngoingEvent2> createState() => _NoOngoingEvent2State();
}

class _NoOngoingEvent2State extends State<NoOngoingEvent2> {
  @override
    ...
    return Scaffold(
      body: Column(
        children: [
          ...
          Center(
            child: Text("Sorry, We couldn’t find any event.",style: TextStyle(
                fontSize: 16,
          ...
          Container(
            ...
            child: Center(
              child: Text("Browse Events",style: TextStyle(
