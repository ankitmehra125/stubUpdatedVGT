...
class ProfileCreatedSuccess extends StatelessWidget {
  const ProfileCreatedSuccess({super.key});

  Future<void> _handleBackButton(BuildContext context) async {
    // Handle back button press here
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => O_HomeFeed()), // Replace HomeFeed() with the actual class for your home feed
    );
  }
